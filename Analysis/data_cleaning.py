...
data = pd.read_csv("../Files/product_visibility_challenge_data.csv")
...
frame.to_csv("../Files/cleaned_product_visibility.csv", index=False)
print("Cleaned data set saved as: cleaned_product_visibility.csv in the folder labelled 'Data' within the root directory of this project...")
